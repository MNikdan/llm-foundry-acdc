...
def create_hf_bert_mlm(pretrained_model_name_or_path: str = 'bert-base-uncased',
    ...
    Args:
        ...
        pretrained (bool, optional): Whether to initialize the model with the pretrained weights. Default: ``False``.
    ...
    if pretrained:
        ...
        model = transformers.AutoModelForMaskedLM.from_pretrained(
            pretrained_model_name_or_path=pretrained_model_name_or_path, **model_config)
    else:
